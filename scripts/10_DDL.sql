...
CREATE TABLE employee (
    ...
    FOREIGN KEY (reports_to) REFERENCES employee
);
...
--
-- Name: shipper; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE TABLE "order" (
    ...
    FOREIGN KEY (ship_via) REFERENCES shipper
);


--
-- Name: territory; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: employee_territory; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE TABLE employee_territory (
    ...
    FOREIGN KEY (territory_id) REFERENCES territory,
    FOREIGN KEY (employee_id) REFERENCES employee
);
...
--
-- Name: us_state; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
